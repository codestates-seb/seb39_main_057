...
//    static Roles roles = new Roles("ROLE_USER");
    ...
    public static Item getSinglePost() {
        ...
        Item item = new Item(member, "Title1", 2, foodCategory, deadline, pickupLocation,  "Restaurant1", "http://test-url.com", "Body1", imageUrl);
    ...
    public static Page<Item> getMultiItems() {
        ...
        Item item1 = new Item(member, "Title1",2, foodCategory, deadline, pickupLocation,  "Restaurant1", "http://test-url.com", "Body1", imageUrl);
        Item item2 = new Item(member, "Title1",2, foodCategory, deadline, pickupLocation,  "Restaurant1", "http://test-url.com", "Body1", imageUrl);
        Item item3 = new Item(member, "Title1",2, foodCategory, deadline, pickupLocation,  "Restaurant1", "http://test-url.com", "Body1", imageUrl);
        Item item4 = new Item(member, "Title1",2, foodCategory, deadline, pickupLocation,  "Restaurant1", "http://test-url.com", "Body1", imageUrl);
        Item item5 = new Item(member, "Title1",2, foodCategory, deadline, pickupLocation,  "Restaurant1", "http://test-url.com", "Body1", imageUrl);
        Item item6 = new Item(member, "Title1",2, foodCategory, deadline, pickupLocation,  "Restaurant1", "http://test-url.com", "Body1", imageUrl);
        Item item7 = new Item(member, "Title1",2, foodCategory, deadline, pickupLocation,  "Restaurant1", "http://test-url.com", "Body1", imageUrl);
        Item item8 = new Item(member, "Title1",2, foodCategory, deadline, pickupLocation,  "Restaurant1", "http://test-url.com", "Body1", imageUrl);
        Item item9 = new Item(member, "Title1",2, foodCategory, deadline, pickupLocation,  "Restaurant1", "http://test-url.com", "Body1", imageUrl);
        Item item10 = new Item(member, "Title1",2, foodCategory, deadline, pickupLocation,  "Restaurant1", "http://test-url.com", "Body1", imageUrl);
